...
# -----------------------------------------------------------------------------
ensemble_name = 'TV-Ensemble-Validation-OutofRange'  #name for the directory to put ensemble in
reference_run = 'overland_tiltedV.yaml' #yaml file for baseline run definition to use

# Variables to change
channel_slopes = [0.01, 0.02]
hill_slopes=[0.01, 0.2]
mannings = [5.00E-06, 2.08E-05]
rainvals = [-0.001, -0.02]
rainlens = [1, 5]
