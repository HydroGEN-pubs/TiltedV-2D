...
# Variables to change
channel_slopes = [0.001, 0.004, 0.007, 0.01]
hill_slopes=[0.05, 0.083, 0.117, 0.15]
mannings = [8.30E-06, 8.77E-06, 9.25E-06, 9.72E-06]
rainvals = [-0.005, -0.01, -0.015, -0.02]
rainlens = [2, 3, 4, 5]
 
df_names = ['channel_slope', 'hill_slopes', 'mannings',  'rain_length', 'rain_value']
